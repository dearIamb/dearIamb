...
$\texttt{\color{#A10E04}   ‧₊˚♪ 𝄞₊˚⊹  }$ [𝒂𝒕𝒂](https://iknowuraddress.atabook.org/) $\texttt{\color{#A10E04}   ‧₊˚♪ 𝄞₊˚⊹  }$

$\texttt{\color{#80000E}   ‧₊˚♪ 𝄞₊˚⊹  }$ [𝒈𝒖𝒏𝒔 𝒘𝒊𝒑](https://guns.lol/teary_eyedloser) $\texttt{\color{#80000E}   ‧₊˚♪ 𝄞₊˚⊹  }$

$\texttt{\color{#80000E}   strawpage editor is currently buggy asf, so i wont be putting it on rn.  }$
